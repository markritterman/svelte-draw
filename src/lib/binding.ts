...
export function updateBoundPoints(
  ...
  if (lineElement.startBinding) {
    ...
    if (boundElement) {
      startPoint = getBindingPoint(boundElement, endPoint, lineElement.startBinding.gap);
    }
  }
  ...
  if (lineElement.endBinding) {
    ...
    if (boundElement) {
      endPoint = getBindingPoint(boundElement, startPoint, lineElement.endBinding.gap);
    }
  }
